...
This is my personal portfolio website, The site is built using Gatsby, a React-based static site generator, and is hosted on Netlify.
...
1.  **Create a Gatsby site.**
    ...
    gatsby new my-portfolio-site https://github.com/gatsbyjs/gatsby-starter-default
    ```
